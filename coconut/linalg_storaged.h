...
vector_shape_t TOP_LEVEL_linalg_vectorMap_c(closure_t f_c, vector_shape_t v_c) {
	...
	return nested_shape_card_t(0, v_c.card);
}
...
vector_shape_t TOP_LEVEL_linalg_vectorRange_c(card_t s_c, card_t e_c) {
	...
	return nested_shape_card_t(0, ((e_c) - (s_c)) + (1));
}
...
vector_shape_t TOP_LEVEL_linalg_vectorSlice_c(card_t size_c, card_t offset_c, vector_shape_t v_c) {
	...
	return nested_shape_card_t(0, size_c);
}


array_number_t TOP_LEVEL_linalg_vectorSlice_s(storage_t stgVar11, card_t size_s, index_t offset_s, array_number_t v_s, card_t size_c, card_t offset_c, vector_shape_t v_c) {
...
matrix_shape_t TOP_LEVEL_linalg_matrixMap_c(closure_t f_c, matrix_shape_t m_c) {
	...
	return nested_shape_vector_shape_t(f_c.lam(f_c.env, m_c.elem).vector_shape_t_value, m_c.card);
}
...
array_array_number_t TOP_LEVEL_linalg_matrixMap_s(storage_t stgVar15, closure_t f_s, array_array_number_t m_s, closure_t f_c, matrix_shape_t m_c) {
	...
	array_array_number_t macroDef22 = (array_array_number_t)stgVar15;
		...
		for(int i_s = 0; i_s < macroDef22->length; i_s++){
			card_t size23 = width_vector_shape_t(m_c.elem);
...
vector_shape_t TOP_LEVEL_linalg_vectorMap2_c(closure_t f_c, vector_shape_t v1_c, vector_shape_t v2_c) {
	...
	return nested_shape_card_t(0, v1_c.card);
}


array_number_t TOP_LEVEL_linalg_vectorMap2_s(storage_t stgVar24, closure_t f_s, array_number_t v1_s, array_number_t v2_s, closure_t f_c, vector_shape_t v1_c, vector_shape_t v2_c) {
...
matrix_shape_t TOP_LEVEL_linalg_matrixMap2_c(closure_t f_c, matrix_shape_t m1_c, matrix_shape_t m2_c) {
	...
	return nested_shape_vector_shape_t(f_c.lam(f_c.env, m1_c.elem, m2_c.elem).vector_shape_t_value, m1_c.card);
}
...
array_array_number_t TOP_LEVEL_linalg_matrixMap2_s(storage_t stgVar33, closure_t f_s, array_array_number_t m1_s, array_array_number_t m2_s, closure_t f_c, matrix_shape_t m1_c, matrix_shape_t m2_c) {
	...
	array_array_number_t macroDef43 = (array_array_number_t)stgVar33;
		...
		for(int i_s = 0; i_s < macroDef43->length; i_s++){
			card_t size45 = width_vector_shape_t(m2_c.elem);
	array_number_t stgVar37 = storage_alloc(size45);
	array_number_t macroDef42;card_t size44 = width_vector_shape_t(m1_c.elem);
...
matrix_shape_t TOP_LEVEL_linalg_vectorMapToMatrix_c(closure_t f_c, vector_shape_t arr_c) {
	...
	return nested_shape_vector_shape_t(f_c.lam(f_c.env, 0).vector_shape_t_value, arr_c.card);
}


array_array_number_t TOP_LEVEL_linalg_vectorMapToMatrix_s(storage_t stgVar59, closure_t f_s, array_number_t arr_s, closure_t f_c, vector_shape_t arr_c) {
...
matrix3d_shape_t TOP_LEVEL_linalg_vectorMapToMatrix3D_c(closure_t f_c, vector_shape_t arr_c) {
	...
	return nested_shape_matrix_shape_t(f_c.lam(f_c.env, 0).matrix_shape_t_value, arr_c.card);
}


array_array_array_number_t TOP_LEVEL_linalg_vectorMapToMatrix3D_s(storage_t stgVar66, closure_t f_s, array_number_t arr_s, closure_t f_c, vector_shape_t arr_c) {
...
array_number_t TOP_LEVEL_linalg_iterateVector_s(storage_t stgVar80, closure_t f_s, array_number_t z_s, card_t s_s, card_t e_s, closure_t f_c, vector_shape_t z_c, card_t s_c, card_t e_c) {
...
number_t TOP_LEVEL_linalg_arraySum_s(storage_t stgVar101, array_number_t arr_s, vector_shape_t arr_c) {
...
number_t TOP_LEVEL_linalg_arrayMax_s(storage_t stgVar104, array_number_t arr_s, vector_shape_t arr_c) {
...
array_number_t TOP_LEVEL_linalg_mult_by_scalar_s(storage_t stgVar108, array_number_t x_s, number_t y_s, vector_shape_t x_c, card_t y_c) {
...
array_number_t TOP_LEVEL_linalg_cross_s(storage_t stgVar125, array_number_t a_s, array_number_t b_s, vector_shape_t a_c, vector_shape_t b_c) {
...
array_number_t TOP_LEVEL_linalg_add_vec_s(storage_t stgVar142, array_number_t x_s, array_number_t y_s, vector_shape_t x_c, vector_shape_t y_c) {
...
array_number_t TOP_LEVEL_linalg_mult_vec_elementwise_s(storage_t stgVar159, array_number_t x_s, array_number_t y_s, vector_shape_t x_c, vector_shape_t y_c) {
...
array_number_t TOP_LEVEL_linalg_add_vec3_s(storage_t stgVar176, array_number_t x_s, array_number_t y_s, array_number_t z_s, vector_shape_t x_c, vector_shape_t y_c, vector_shape_t z_c) {
	card_t size182 = width_vector_shape_t(TOP_LEVEL_linalg_add_vec_c(x_c, y_c));
...
array_number_t TOP_LEVEL_linalg_sub_vec_s(storage_t stgVar183, array_number_t x_s, array_number_t y_s, vector_shape_t x_c, vector_shape_t y_c) {
...
value_t lambda210(env_t_210* env207, vector_shape_t x_c, vector_shape_t y_c) {
...
value_t lambda217(env_t_217* env211, storage_t stgVar204, array_number_t x_s, array_number_t y_s, vector_shape_t x_c, vector_shape_t y_c) {
...
value_t lambda218(env_t_218* env214, vector_shape_t x_c, vector_shape_t y_c) {
...
value_t lambda229(env_t_229* env226, vector_shape_t x_c, vector_shape_t y_c) {
...
value_t lambda236(env_t_236* env230, storage_t stgVar223, array_number_t x_s, array_number_t y_s, vector_shape_t x_c, vector_shape_t y_c) {
...
value_t lambda237(env_t_237* env233, vector_shape_t x_c, vector_shape_t y_c) {
...
number_t TOP_LEVEL_linalg_sqnorm_s(storage_t stgVar238, array_number_t x_s, vector_shape_t x_c) {
	env_t_256 env_t_256_value = make_empty_env(); closure_t closure245 = make_closure(lambda256, &env_t_256_value);
	card_t size260 = width_vector_shape_t(TOP_LEVEL_linalg_vectorMap_c(closure245, x_c));
...
number_t TOP_LEVEL_linalg_dot_prod_s(storage_t stgVar261, array_number_t x_s, array_number_t y_s, vector_shape_t x_c, vector_shape_t y_c) {
	env_t_280 env_t_280_value = make_empty_env(); closure_t closure269 = make_closure(lambda280, &env_t_280_value);
	card_t size284 = width_vector_shape_t(TOP_LEVEL_linalg_vectorMap2_c(closure269, x_c, y_c));
...
env_t_295 make_env_t_295(vector_shape_t row_c) {
	env_t_295 env;
	env.row_c = row_c;
	return env;
}
...
value_t lambda295(env_t_295* env292, card_t r_c) {
	vector_shape_t row_c291 = env292->row_c;
	value_t res;
	res.vector_shape_t_value = row_c291;
	return res;
}
...
env_t_306 make_env_t_306(vector_shape_t row_c) {
	env_t_306 env;
	env.row_c = row_c;
	return env;
}
...
value_t lambda306(env_t_306* env301, card_t r_c) {
	vector_shape_t row_c300 = env301->row_c;
	value_t res;
	res.vector_shape_t_value = row_c300;
	return res;
}
array_array_number_t TOP_LEVEL_linalg_matrixFillFromVector_s(storage_t stgVar285, card_t rows_s, array_number_t row_s, card_t rows_c, vector_shape_t row_c) {
	card_t size307 = width_vector_shape_t(TOP_LEVEL_linalg_vectorRange_c(1, rows_c));
...
matrix_shape_t TOP_LEVEL_linalg_matrixFill_c(card_t rows_c, card_t cols_c, card_t value_c) {
	...
	return nested_shape_vector_shape_t(nested_shape_card_t(0, cols_c), rows_c);
}
...
array_array_number_t TOP_LEVEL_linalg_matrixFill_s(storage_t stgVar308, card_t rows_s, card_t cols_s, number_t value_s, card_t rows_c, card_t cols_c, card_t value_c) {
	array_array_number_t macroDef315 = (array_array_number_t)stgVar308;
		macroDef315->length=rows_s;
		macroDef315->arr=(array_number_t*)(STG_OFFSET(macroDef315, VECTOR_HEADER_BYTES));
		storage_t stgVar309 = (STG_OFFSET(macroDef315, MATRIX_HEADER_BYTES(rows_s)));
		for(int r_s = 0; r_s < macroDef315->length; r_s++){
		...
		for(int c_s = 0; c_s < macroDef311->length; c_s++){
			...
			macroDef315->arr[r_s] = macroDef311;;
			stgVar309 = STG_OFFSET(stgVar309, VECTOR_ALL_BYTES(macroDef315->arr[r_s]->length));
		}
	return macroDef315;
}
...
matrix_shape_t TOP_LEVEL_linalg_matrixTranspose_c(matrix_shape_t m_c) {
	...
	return nested_shape_vector_shape_t(nested_shape_card_t(0, m_c.card), m_c.elem.card);
}


array_array_number_t TOP_LEVEL_linalg_matrixTranspose_s(storage_t stgVar316, array_array_number_t m_s, matrix_shape_t m_c) {
	card_t rows_c = m_c.card;
	card_t macroDef328 = m_s->length;
	card_t rows_s = macroDef328;
	card_t cols_c = m_c.elem.card;
	card_t size337 = width_vector_shape_t(m_c.elem);
	array_number_t stgVar320 = storage_alloc(size337);
	card_t macroDef330;card_t macroDef329 = m_s->arr[0]->length;
	macroDef330 = macroDef329;;
	storage_free(stgVar320, size337);
	card_t cols_s = macroDef330;
	array_array_number_t macroDef336 = (array_array_number_t)stgVar316;
		macroDef336->length=cols_s;
		macroDef336->arr=(array_number_t*)(STG_OFFSET(macroDef336, VECTOR_HEADER_BYTES));
		storage_t stgVar322 = (STG_OFFSET(macroDef336, MATRIX_HEADER_BYTES(cols_s)));
		for(int i_s = 0; i_s < macroDef336->length; i_s++){
			array_number_t macroDef332 = (array_number_t)stgVar322;
		macroDef332->length=rows_s;
		macroDef332->arr=(number_t*)(STG_OFFSET(macroDef332, VECTOR_HEADER_BYTES));
		storage_t stgVar323 = macroDef332;
		for(int j_s = 0; j_s < macroDef332->length; j_s++){
			card_t size338 = width_vector_shape_t(m_c.elem);
	array_number_t stgVar324 = storage_alloc(size338);
	number_t macroDef331;
	macroDef331 = m_s->arr[j_s]->arr[i_s];;
	storage_free(stgVar324, size338);
			macroDef332->arr[j_s] = macroDef331;;
			stgVar323 = STG_OFFSET(stgVar323, sizeof(number_t));
		}
			macroDef336->arr[i_s] = macroDef332;;
			stgVar322 = STG_OFFSET(stgVar322, VECTOR_ALL_BYTES(macroDef336->arr[i_s]->length));
		}
	return macroDef336;
}
...
matrix_shape_t TOP_LEVEL_linalg_matrixMult_c(matrix_shape_t m1_c, matrix_shape_t m2_c) {
	...
	return nested_shape_vector_shape_t(nested_shape_card_t(0, m2_c.elem.card), m1_c.card);
}


array_array_number_t TOP_LEVEL_linalg_matrixMult_s(storage_t stgVar339, array_array_number_t m1_s, array_array_number_t m2_s, matrix_shape_t m1_c, matrix_shape_t m2_c) {
	card_t r1_c = m1_c.card;
	card_t macroDef378 = m1_s->length;
	card_t r1_s = macroDef378;
	card_t c2_c = m2_c.elem.card;
	card_t size392 = width_vector_shape_t(m2_c.elem);
	array_number_t stgVar343 = storage_alloc(size392);
	card_t macroDef380;card_t macroDef379 = m2_s->arr[0]->length;
	macroDef380 = macroDef379;;
	storage_free(stgVar343, size392);
	card_t c2_s = macroDef380;
	card_t c1_c = m1_c.elem.card;
	card_t size393 = width_vector_shape_t(m1_c.elem);
	array_number_t stgVar346 = storage_alloc(size393);
	card_t macroDef382;card_t macroDef381 = m1_s->arr[0]->length;
	macroDef382 = macroDef381;;
	storage_free(stgVar346, size393);
	card_t c1_s = macroDef382;
	card_t r2_c = m2_c.card;
	card_t macroDef383 = m2_s->length;
	card_t r2_s = macroDef383;
	matrix_shape_t m2T_c = TOP_LEVEL_linalg_matrixTranspose_c(m2_c);
	card_t size396 = width_matrix_shape_t(m2T_c);
	array_number_t stgVar350 = storage_alloc(size396);
	array_array_number_t macroDef391;array_array_number_t m2T_s = TOP_LEVEL_linalg_matrixTranspose_s(stgVar350, m2_s, m2_c);
	array_array_number_t macroDef390 = (array_array_number_t)stgVar339;
		macroDef390->length=r1_s;
		macroDef390->arr=(array_number_t*)(STG_OFFSET(macroDef390, VECTOR_HEADER_BYTES));
		storage_t stgVar352 = (STG_OFFSET(macroDef390, MATRIX_HEADER_BYTES(r1_s)));
		for(int r_s = 0; r_s < macroDef390->length; r_s++){
			array_number_t macroDef386 = (array_number_t)stgVar352;
		macroDef386->length=c2_s;
		macroDef386->arr=(number_t*)(STG_OFFSET(macroDef386, VECTOR_HEADER_BYTES));
		storage_t stgVar353 = macroDef386;
		for(int c_s = 0; c_s < macroDef386->length; c_s++){
			card_t size395 = width_vector_shape_t(m2T_c.elem);
	array_number_t stgVar355 = storage_alloc(size395);
	number_t macroDef385;card_t size394 = width_vector_shape_t(m1_c.elem);
	array_number_t stgVar354 = storage_alloc(size394);
	number_t macroDef384;
	macroDef384 = TOP_LEVEL_linalg_dot_prod_s(stgVar353, m1_s->arr[r_s], m2T_s->arr[c_s], m1_c.elem, m2T_c.elem);;
	storage_free(stgVar354, size394);
	macroDef385 = macroDef384;;
	storage_free(stgVar355, size395);
			macroDef386->arr[c_s] = macroDef385;;
			stgVar353 = STG_OFFSET(stgVar353, sizeof(number_t));
		}
			macroDef390->arr[r_s] = macroDef386;;
			stgVar352 = STG_OFFSET(stgVar352, VECTOR_ALL_BYTES(macroDef390->arr[r_s]->length));
		}
	macroDef391 = macroDef390;;
	storage_free(stgVar350, size396);
	return macroDef391;
}

matrix_shape_t TOP_LEVEL_linalg_matrixConcat_c(matrix_shape_t m1_c, matrix_shape_t m2_c) {
	
	return nested_shape_vector_shape_t(m1_c.elem, (m1_c.card) + (m2_c.card));
}


array_array_number_t TOP_LEVEL_linalg_matrixConcat_s(storage_t stgVar397, array_array_number_t m1_s, array_array_number_t m2_s, matrix_shape_t m1_c, matrix_shape_t m2_c) {
	card_t rows_c = (m1_c.card) + (m2_c.card);
	card_t macroDef408 = m1_s->length;
	card_t macroDef409 = m2_s->length;
	card_t rows_s = (macroDef408) + (macroDef409);
	card_t m1Rows_c = 0;
	card_t macroDef410 = m1_s->length;
	index_t m1Rows_s = (macroDef410);
	array_array_number_t macroDef411 = (array_array_number_t)stgVar397;
		macroDef411->length=rows_s;
		macroDef411->arr=(array_number_t*)(STG_OFFSET(macroDef411, VECTOR_HEADER_BYTES));
		storage_t stgVar403 = (STG_OFFSET(macroDef411, MATRIX_HEADER_BYTES(rows_s)));
		for(int r_s = 0; r_s < macroDef411->length; r_s++){
			array_number_t ite412 = 0;
	if((r_s) < (m1Rows_s)) {
		
		ite412 = m1_s->arr[r_s];;
	} else {
		
		ite412 = m2_s->arr[(r_s) - (m1Rows_s)];;
	}
			macroDef411->arr[r_s] = ite412;;
			stgVar403 = STG_OFFSET(stgVar403, VECTOR_ALL_BYTES(macroDef411->arr[r_s]->length));
		}
	return macroDef411;
}
...
array_array_number_t TOP_LEVEL_linalg_matrixConcatCol_s(storage_t stgVar413, array_array_number_t m1_s, array_array_number_t m2_s, matrix_shape_t m1_c, matrix_shape_t m2_c) {
	matrix_shape_t m1t_c = TOP_LEVEL_linalg_matrixTranspose_c(m1_c);
	card_t size428 = width_matrix_shape_t(m1t_c);
	array_number_t stgVar414 = storage_alloc(size428);
	array_array_number_t macroDef425;array_array_number_t m1t_s = TOP_LEVEL_linalg_matrixTranspose_s(stgVar414, m1_s, m1_c);
	matrix_shape_t m2t_c = TOP_LEVEL_linalg_matrixTranspose_c(m2_c);
	card_t size427 = width_matrix_shape_t(m2t_c);
	array_number_t stgVar416 = storage_alloc(size427);
	array_array_number_t macroDef424;array_array_number_t m2t_s = TOP_LEVEL_linalg_matrixTranspose_s(stgVar416, m2_s, m2_c);
	card_t size426 = width_matrix_shape_t(TOP_LEVEL_linalg_matrixConcat_c(m1t_c, m2t_c));
	array_number_t stgVar418 = storage_alloc(size426);
	array_array_number_t macroDef423;
	macroDef423 = TOP_LEVEL_linalg_matrixTranspose_s(stgVar413, TOP_LEVEL_linalg_matrixConcat_s(stgVar418, m1t_s, m2t_s, m1t_c, m2t_c), TOP_LEVEL_linalg_matrixConcat_c(m1t_c, m2t_c));;
	storage_free(stgVar418, size426);
	macroDef424 = macroDef423;;
	storage_free(stgVar416, size427);
	macroDef425 = macroDef424;;
	storage_free(stgVar414, size428);
	return macroDef425;
}
...
array_array_array_number_t TOP_LEVEL_linalg_matrix3DConcat_s(storage_t stgVar429, array_array_array_number_t m1_s, array_array_array_number_t m2_s, matrix3d_shape_t m1_c, matrix3d_shape_t m2_c) {
	card_t rows_c = (m1_c.card) + (m2_c.card);
	card_t macroDef440 = m1_s->length;
	card_t macroDef441 = m2_s->length;
	card_t rows_s = (macroDef440) + (macroDef441);
	card_t m1Rows_c = 0;
	card_t macroDef442 = m1_s->length;
	index_t m1Rows_s = (macroDef442);
	array_array_array_number_t macroDef443 = (array_array_array_number_t)stgVar429;
		macroDef443->length=rows_s;
		macroDef443->arr=(array_array_number_t*)(STG_OFFSET(macroDef443, VECTOR_HEADER_BYTES));
		storage_t stgVar435 = (STG_OFFSET(macroDef443, MATRIX_HEADER_BYTES(rows_s)));
		for(int r_s = 0; r_s < macroDef443->length; r_s++){
			array_array_number_t ite444 = 0;
	if((r_s) < (m1Rows_s)) {
		
		ite444 = m1_s->arr[r_s];;
	} else {
		
		ite444 = m2_s->arr[(r_s) - (m1Rows_s)];;
	}
			macroDef443->arr[r_s] = ite444;;
			stgVar435 = STG_OFFSET(stgVar435, VECTOR_ALL_BYTES(macroDef443->arr[r_s]->length));
		}
	return macroDef443;
}
...
vector_shape_t TOP_LEVEL_linalg_vectorRead_c(card_t fn_c, card_t startLine_c) {
	...
	return nested_shape_vector_shape_t(nested_shape_card_t(0, 10), 1).elem;
}


array_number_t TOP_LEVEL_linalg_vectorRead_s(storage_t stgVar445, string_t fn_s, index_t startLine_s, card_t fn_c, card_t startLine_c) {
	matrix_shape_t matrix_c = nested_shape_vector_shape_t(nested_shape_card_t(0, 10), 1);
	card_t size449 = width_matrix_shape_t(matrix_c);
	array_number_t stgVar446 = storage_alloc(size449);
	array_number_t macroDef448;array_array_number_t matrix_s = matrix_read_s(stgVar446, fn_s, startLine_s, 1);
	macroDef448 = matrix_s->arr[0];;
	storage_free(stgVar446, size449);
	return macroDef448;
}
...
number_t TOP_LEVEL_linalg_numberRead_s(storage_t stgVar450, string_t fn_s, index_t startLine_s, card_t fn_c, card_t startLine_c) {
	vector_shape_t vector_c = TOP_LEVEL_linalg_vectorRead_c(0, 0);
	card_t size456 = width_vector_shape_t(vector_c);
	array_number_t stgVar451 = storage_alloc(size456);
	number_t macroDef455;array_number_t vector_s = TOP_LEVEL_linalg_vectorRead_s(stgVar451, fn_s, startLine_s, 0, 0);
	macroDef455 = vector_s->arr[0];;
	storage_free(stgVar451, size456);
	return macroDef455;
}
#endif
