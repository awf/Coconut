...
value_t lambda108(env_t_108* env105, number_t i) {
	...
	value_t res;
	res.array_number_t_value = linalg_compute_reproj_err(cams100->arr[(int)(obs102->arr[(int)(i)]->arr[0])], x104->arr[(int)(obs102->arr[(int)(i)]->arr[1])], w103->arr[(int)(i)], feat101->arr[(int)(i)]);
	return res;
}
...
value_t lambda187(env_t_187* env184, number_t i_bone) {
	...
	value_t res;
	res.array_array_number_t_value = linalg_make_relative(pose_params183->arr[((int)(i_bone)) + (offset182)], base_relatives181->arr[(int)(i_bone)]);
	return res;
}
