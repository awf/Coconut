...
array_array_number_t linalg_to_pose_params(array_number_t theta, index_t n_bones) {
	...
	finger5->arr[0] = array105;
	finger5->arr[1] = array106;
	finger5->arr[2] = array107;
	finger5->arr[3] = array108;;
