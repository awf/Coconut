...
array_array_number_t TOP_LEVEL_usecases_ht_new_matrix_test(array_number_t dum) {
	array_number_t array132 = (array_number_t)storage_alloc(sizeof(int) * 2);
	array132->length=3;
	array132->arr = (number_t*)storage_alloc(sizeof(number_t) * 3);
	array132->arr[0] = 0;
	array132->arr[1] = 0;
	array132->arr[2] = 0;;
	array_array_number_t res = (array_array_number_t)storage_alloc(sizeof(int) * 2);
	res->length=1;
	res->arr = (array_number_t*)storage_alloc(sizeof(array_number_t) * 1);
	res->arr[0] = array132;;
	return res;
}
...
array_array_number_t TOP_LEVEL_usecases_ht_to_pose_params(array_number_t theta, card_t n_bones) {
	...
	index_t i1 = 5;
	array_number_t array133 = (array_number_t)storage_alloc(sizeof(int) * 2);
	array133->length=3;
	array133->arr = (number_t*)storage_alloc(sizeof(number_t) * 3);
	array133->arr[0] = theta->arr[i1];
	array133->arr[1] = theta->arr[(i1) + (1)];
	array133->arr[2] = 0;;
	array_number_t array134 = (array_number_t)storage_alloc(sizeof(int) * 2);
	array134->length=3;
	array134->arr = (number_t*)storage_alloc(sizeof(number_t) * 3);
	array134->arr[0] = theta->arr[(i1) + (2)];
	array134->arr[1] = 0;
	array134->arr[2] = 0;;
	array_number_t array135 = (array_number_t)storage_alloc(sizeof(int) * 2);
	array135->length=3;
	array135->arr = (number_t*)storage_alloc(sizeof(number_t) * 3);
	array135->arr[0] = theta->arr[(i1) + (3)];
	array135->arr[1] = 0;
	array135->arr[2] = 0;;
	array_number_t array136 = (array_number_t)storage_alloc(sizeof(int) * 2);
	array136->length=3;
	array136->arr = (number_t*)storage_alloc(sizeof(number_t) * 3);
	array136->arr[0] = 0;
	array136->arr[1] = 0;
	array136->arr[2] = 0;;
	...
	index_t i2 = (i1) + (4);
	array_number_t array137 = (array_number_t)storage_alloc(sizeof(int) * 2);
	array137->length=3;
	array137->arr = (number_t*)storage_alloc(sizeof(number_t) * 3);
...
array_array_number_t TOP_LEVEL_usecases_ht_make_relative(array_number_t pose_params, array_array_number_t base_relative) {
	...
	array162->length=1;
	array162->arr = (number_t*)storage_alloc(sizeof(number_t) * 1);
	array162->arr[0] = 0;;
	array_number_t array163 = (array_number_t)storage_alloc(sizeof(int) * 2);
	array163->length=1;
	array163->arr = (number_t*)storage_alloc(sizeof(number_t) * 1);
	array163->arr[0] = 0;;
	array_number_t array164 = (array_number_t)storage_alloc(sizeof(int) * 2);
	array164->length=1;
	array164->arr = (number_t*)storage_alloc(sizeof(number_t) * 1);
	array164->arr[0] = 0;;
	...
	array165->length=4;
	array165->arr = (number_t*)storage_alloc(sizeof(number_t) * 4);
	array165->arr[0] = 0;
	array165->arr[1] = 0;
	array165->arr[2] = 0;
	array165->arr[3] = 1;;
...
array_array_number_t TOP_LEVEL_usecases_ht_angle_axis_to_rotation_matrix(array_number_t angle_axis) {
	...
	array177->arr[1] = 0;
	array177->arr[2] = 1;;
		array_array_number_t array174 = (array_array_number_t)storage_alloc(sizeof(int) * 2);
	array174->length=3;
	array174->arr = (array_number_t*)storage_alloc(sizeof(array_number_t) * 3);
	...
	array181->arr[2] = ((z) * (z)) + (((1) - ((z) * (z))) * (c));;
		array_array_number_t array178 = (array_array_number_t)storage_alloc(sizeof(int) * 2);
	array178->length=3;
	array178->arr = (array_number_t*)storage_alloc(sizeof(array_number_t) * 3);
...
array_array_array_number_t TOP_LEVEL_usecases_ht_relatives_to_absolutes(array_array_array_number_t relatives, array_number_t parents) {
	array_number_t array189 = (array_number_t)storage_alloc(sizeof(int) * 2);
	array189->length=0;
	array189->arr = (number_t*)storage_alloc(sizeof(number_t) * 0);
	;
	array_array_number_t array188 = (array_array_number_t)storage_alloc(sizeof(int) * 2);
	array188->length=1;
	array188->arr = (array_number_t*)storage_alloc(sizeof(array_number_t) * 1);
...
array_array_number_t TOP_LEVEL_usecases_ht_get_skinned_vertex_positions(index_t is_mirrored, card_t n_bones, array_array_number_t pose_params, array_array_array_number_t base_relatives, array_number_t parents, array_array_array_number_t inverse_base_absolutes, array_array_number_t base_positions, array_array_number_t weights) {
	...
	if((is_mirrored) == (1)) {
		array_number_t array216 = (array_number_t)storage_alloc(sizeof(int) * 2);
	array216->length=3;
	array216->arr = (number_t*)storage_alloc(sizeof(number_t) * 3);
	array216->arr[0] = -1;
	array216->arr[1] = 0;
	array216->arr[2] = 0;;
		array_number_t array217 = (array_number_t)storage_alloc(sizeof(int) * 2);
	array217->length=3;
	array217->arr = (number_t*)storage_alloc(sizeof(number_t) * 3);
	array217->arr[0] = 0;
	array217->arr[1] = 1;
	array217->arr[2] = 0;;
		array_number_t array218 = (array_number_t)storage_alloc(sizeof(int) * 2);
	array218->length=3;
	array218->arr = (number_t*)storage_alloc(sizeof(number_t) * 3);
	array218->arr[0] = 0;
	array218->arr[1] = 0;
	array218->arr[2] = 1;;
...
void TOP_LEVEL_usecases_ht_test_ht(array_number_t dum) {
	...
	a->arr[2] = 3;;
	array_print(a);
	array_number_t array233 = (array_number_t)storage_alloc(sizeof(int) * 2);
	array233->length=3;
	array233->arr = (number_t*)storage_alloc(sizeof(number_t) * 3);
	array233->arr[0] = 1;
	array233->arr[1] = 2;
	array233->arr[2] = 3;;
	array_number_t array234 = (array_number_t)storage_alloc(sizeof(int) * 2);
	array234->length=3;
	array234->arr = (number_t*)storage_alloc(sizeof(number_t) * 3);
	array234->arr[0] = 4;
	array234->arr[1] = 5;
	array234->arr[2] = 6;;
	array_number_t array235 = (array_number_t)storage_alloc(sizeof(int) * 2);
	array235->length=3;
	array235->arr = (number_t*)storage_alloc(sizeof(number_t) * 3);
	array235->arr[0] = 7;
	array235->arr[1] = 8;
	array235->arr[2] = 9;;
